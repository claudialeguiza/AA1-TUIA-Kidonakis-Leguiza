...
def cargar_modelo_regresion():
    modelo_regresion = load_model(r'C:\Users\solki\OneDrive\Documentos\AA1-TUIA-Kidonakis-Leguiza\regression_model.h5')
    return modelo_regresion

def cargar_modelo_clasificacion():
    modelo_clasif = load_model(r'C:\Users\solki\OneDrive\Documentos\AA1-TUIA-Kidonakis-Leguiza\classification_model_optimized.h5')
...
df = pd.read_csv(r'C:\Users\solki\OneDrive\Documentos\Joblibs_AA1\weatherAUS.csv')

# Seleccionar solo columnas numéricas
columnas_numericas = df.select_dtypes(include=['number']).columns.tolist()

# Cargar los pipelines desde los archivos joblib
path_regresion = r'C:\Users\solki\OneDrive\Documentos\Joblibs_AA1\regresion_pipeline.joblib'
path_clasificacion = r'C:\Users\solki\OneDrive\Documentos\Joblibs_AA1\clasificacion_pipeline.joblib'
